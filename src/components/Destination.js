...
const Destination = ()=>{
    ...
    text1="This institute offers undergraduates courses in B.Tech, BCA, & BBA, and post-graduates in MBA & M.Tech."
    img1={logo1}
    />
...
<DestinationData 
    ...
    text1="The department of management is the essence of excellence and design to develop the future managers. Department 
...
className="first-des"
    ...
    text1="The Conference is devoted to deliberate issues and challenges in the field of Commerce and Management."
    text2="To provide a better platform for expression of their innovative ideas & thoughts among all the participants."
    text3="There will be discussions from the academia-industry experts on various topics, like new education policy, 
